...
- `main`: This branch reflects ongoing development in Placer Toolkit. All PRs must be submitted to this branch. Any changes made in this branch can be previewed in [preview-placer-toolkit.netlify.app](https://preview-placer-toolkit.netlify.app).
- `1.0-deploy`: This branch reflects the latest Placer Toolkit v1 release and powers [placer-toolkit.netlify.app](https://placer-toolkit.netlify.app).
- `pre-1.0-deploy`: This branch contains a historical archive of Placer Toolkit v0.5.1. You can find the historical snapshot on [v0-placer-toolkit.netlify.app](https://v0-placer-toolkit.netlify.app).
