...
To understand how our website is used and to improve it, we use [Cabin Analytics](https://withcabin.com), a privacy‐first analytics tool that is compliant with GDPR and other privacy laws. You can read their privacy policy at [https://withcabin.com/privacy](https://withcabin.com/privacy). This tool collects anonymised or aggregated data that is not used to identify individual users:
