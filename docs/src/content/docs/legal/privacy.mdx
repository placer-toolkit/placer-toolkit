...
<pc-callout appearance="primary" size="small">
    <pc-icon
        ...
        slot="icon"
    ></pc-icon>
    This policy is provided in a concise, transparent and easily accessible form using clear and plain language, in accordance with [GDPR Article 12](https://gdpr-info.eu/art-12-gdpr).
</pc-callout>
...
We use certain external services to ensure that the website functions correctly and loads efficiently. When you visit our website or use Placer Toolkit, your browser may make requests with these services, which may receive technical data such as your IP address as part of normal content delivery (GDPR Art. 6(1)(f)).

#### Vercel

This website is hosted and delivered using Vercel, a U.S.‐based hosting provider. When you visit the site, your browser may send Vercel information like your IP address and device type so the site can be displayed properly and securely. Vercel only uses this data to provide hosting services. Vercel’s privacy practices can be found at [https://vercel.com/legal/privacy-policy](https://vercel.com/legal/privacy-policy).
...
To understand how our website is used and to improve it, we use [Simple Analytics](https://simpleanalytics.com), a privacy‐first analytics tool that is compliant with GDPR and other privacy laws. Simple Analytics doesn’t use cookies and doesn’t collect any personal data. You can read their privacy policy at [https://simpleanalytics.com/privacy](https://simpleanalytics.com/privacy).

This tool only collects aggregated data to analyse trends, such as:

- **Page views:** Which pages are popular.
- **Referrer:** Which site or search engine you came from.
- **Device type:** Whether you are on a phone, tablet or a laptop.
- **Country:** Based on your request, but without storing your IP address.

Because Simple Analytics does not track individual users or store IP addresses, this data is never linked to you and cannot be used to identify you.
...
- **Right to access:** To receive confirmation of whether personal data concerning you is being processed (GDPR Art. 15).
- **Right to rectification:** To have inaccurate personal data corrected (GDPR Art. 16).
- **Right to erasure (“Right to be forgotten”):** To have your personal data deleted, where applicable (GDPR Art. 17).
- **Right to object** or **restrict processing** (where applicable) (GDPR Art. 19 and Art. 21).
