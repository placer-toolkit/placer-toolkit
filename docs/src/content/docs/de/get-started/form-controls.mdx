...
Um ein Feld als Pflichtfeld zu markieren, verwende das Attribut `required`. Pflichtfelder erhalten automatisch ein \* hinter ihrem Label. Dies ist über die Custom Property `--pc-input-required-content` konfigurierbar.
