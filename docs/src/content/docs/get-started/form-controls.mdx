...
```javascript
import { serialize } from "https://cdn.jsdelivr.net/npm/placer-toolkit@1.0.0-alpha.2/cdn/utilities/form.js";
...
<pc-callout appearance="primary">
    <pc-icon
        ...
        slot="icon"
    ></pc-icon>
    In the future, data attributes will be replaced with custom pseudo‐classes such as `:--valid` and `:--invalid`. Placer Toolkit is using data attributes as a workaround until more browsers support custom states through [`ElementInternals.states`](https://developer.mozilla.org/en-US/docs/Web/API/ElementInternals/states).
</pc-callout>
...
<style>
    ...
    /* User invalid styles */
    .input-validation-inline pc-input[data-user-invalid]::part(input) {
        border-color: var(--pc-color-danger-border-loud);
    }
    ...
    .input-validation-inline pc-input:focus-within[data-user-invalid]::part(input) {
        border-color: var(--pc-color-danger-border-loud);
        outline-color: var(--pc-color-danger-border-loud);
    }

    /* User valid styles */
    .input-validation-inline pc-input[data-user-valid]::part(input) {
        border-color: var(--pc-color-success-border-loud);
    }
    ...
    .input-validation-inline pc-input:focus-within[data-user-valid]::part(input) {
        border-color: var(--pc-color-success-border-loud);
        outline-color: var(--pc-color-success-border-loud);
    }
</style>
...
```javascript
import { getFormControls } from "https://cdn.jsdelivr.net/npm/placer-toolkit@1.0.0-alpha.2/cdn/utilities/form.js";
