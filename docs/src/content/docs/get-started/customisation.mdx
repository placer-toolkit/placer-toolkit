...
<pc-tab-group>
    ...
    <pc-tab-panel name="utility">
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/placer-toolkit@1.0.0-alpha.2/cdn/styles/themes/utility.css" />
        ```
    </pc-tab-panel>
    <pc-tab-panel name="serene">
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/placer-toolkit@1.0.0-alpha.2/cdn/styles/themes/serene.css" />
        ```
    </pc-tab-panel>
</pc-tab-group>
...
```javascript
import { setDefaultAnimation } from "https://cdn.jsdelivr.net/npm/placer-toolkit@1.0.0-alpha.2/cdn/utilities/animation-registry.js";
