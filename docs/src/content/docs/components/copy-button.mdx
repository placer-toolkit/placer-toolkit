...
<style>
    pc-copy-button.custom-pink-copy-button::part(button) {
        ...
        color: #fff;
        border: 2px solid;
        border-block-start-color: #ff7ac1;
        border-block-end-color: #ad005c;
        border-inline-start-color: #ff7ac1;
        border-inline-end-color: #ad005c;
        border-radius: 6px;
    ...
    pc-copy-button.custom-pink-copy-button::part(button):active {
        border-block-start-color: #ad005c;
        border-block-end-color: #ff7ac1;
        border-inline-start-color: #ad005c;
        border-inline-end-color: #ff7ac1;
