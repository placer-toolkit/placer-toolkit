...
```demo
<pc-button-group label="Options" orientation="vertical">
    <pc-button>
        <pc-icon
            library="default"
            icon-style="solid"
...
Create a split button using a button and a dropdown. Use a [visually hidden](/docs/style-utilities/visually-hidden) label to ensure the dropdown is accessible to users with assistive devices.
