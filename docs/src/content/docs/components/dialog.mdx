...
<pc-dialog label="Dialog" id="dialog-open-declarative">
    This dialog is opened declaratively using a <code>data</code> attribute on a button outside of the component.
...
<pc-dialog label="Dialog" id="dialog-dismiss-declarative">
    This dialog is dismissed using a declarative close trigger placed inside the dialog’s footer.
...
<pc-dialog label="Dialog" class="dialog-header-actions">
    ...
    This dialog includes an additional action in the header, which can be used for tasks such as opening related content in a new window.
