...
Frames have a square border radius by default. You can add any of the following [`pc-border-radius-*`](/style-utilities/border-radius) classes to an element with `pc-frame` to specify the border radius:
