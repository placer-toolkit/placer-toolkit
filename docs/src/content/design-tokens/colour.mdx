...
Placer Toolkit uses a single colour for all shadows. This is used alongside other [shadow tokens](/design-tokens/shadows) to construct your theme’s shadows.
...
Placer Toolkit uses a single focus colour for predictable keyboard navigation. This is used along other [focus tokens](/design-tokens/focus) to construct `--pc-focus-ring`. We recommend a minimum 3∶1 contrast ratio against surface and background colours wherever possible.
