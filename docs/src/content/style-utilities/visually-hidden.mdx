...
<pc-tab-group>
    ...
    <pc-tab-panel name="in-html">
        ...
        ```html
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/placer-toolkit@1.0.0-alpha.2/cdn/styles/utilities/visually-hidden.css" />
        ```
    </pc-tab-panel>
    <pc-tab-panel name="in-css">
        ...
        ```css
        @import url("https://cdn.jsdelivr.net/npm/placer-toolkit@1.0.0-alpha.2/cdn/styles/utilities/visually-hidden.css");
        ```
    </pc-tab-panel>
</pc-tab-group>
