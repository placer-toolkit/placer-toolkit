...
The default icon library uses Font Awesome Free, which comes with three icon styles: Solid, Regular and Brands. If you’re a Font Awesome Pro user, you can [provide your Kit code](/get-started/installation/#using-font-awesome-kit-codes) to unlock Pro icon packs and styles.
