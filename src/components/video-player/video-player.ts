...
export class PcVideoPlayer extends PlacerElement {
    ...
    private updateCuePosition() {
        ...
        const controlsVisible = this.classList.contains("controls-visible");
        ...
        for (const track of tracks) {
            ...
            for (let i = 0; i < track.activeCues.length; i++) {
                ...
                cue.line = controlsVisible ? -1 : "auto";
            }
        }
    }
        ...
        return html`
            ...
            >
                ...
                <div class="controls" role="group" aria-label="Controls">
                    ...
                    >
                        <pc-button slot="trigger" size="small" variant="filled">
                            <pc-icon
                                library="system"
                                icon-style="solid"
                                name="gauge-high"
                        ...
                        ${[0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2].map(
                            (playbackRate) => html`
                                <pc-dropdown-item value=${playbackRate}>
                                    ${playbackRate}
                                </pc-dropdown-item>
                            `,
                        )}
                    ...
                    <pc-dropdown
                        ...
                        @pc-select=${this.onCaptionSelection.bind(this)}
                    >
                        <pc-button slot="trigger" size="small" variant="filled">
                            <pc-icon
                                library="system"
                        ...
                        ${Array.from(this.video?.textTracks || []).map(
                            (track, index) => html`
