...
| :-------------- | :------------- | :------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Major           | ≥ 1 instance   | PR is immediately closed.                                                                    | Any single failure on a core standard (like SI formatting or smart quotes) results in automatic rejection. The author must correct all errors, perform a new self‐review and reopen the PR. |
