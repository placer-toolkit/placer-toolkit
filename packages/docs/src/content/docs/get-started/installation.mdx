...
Now you can [start using Placer Toolkit](/docs/get-started/usage)!
...
<pc-callout appearance="warning">
    ...
    See the [Placer Toolkit privacy policy](/docs/legal/privacy) for more information.
</pc-callout>
...
This change was introduced in v1.0.0-alpha.1 to fix bare module specifier errors in v0.5.1.
