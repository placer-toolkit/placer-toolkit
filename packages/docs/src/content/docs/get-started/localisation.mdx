...
You can provide your own translations if you have specific needs or if you don’t want to wait for a translation to land upstream. The easiest way to do this is to copy `packages/placer-toolkit/src/translations/en.ts` into your own project and translate the terms inside. When your translation is done, you can import it and use it just like a built‐in translation.
