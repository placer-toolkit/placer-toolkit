...
<style>
    ...
    .checkbox-container .checkbox:focus-within {
    ...
    .checkbox-container .checkbox:has(:checked) {
        background-color: var(--pc-form-control-activated-color);
        border-color: var(--pc-form-control-activated-color);
    }

    .checkbox-container .checkbox:not(:has(:checked)) .checkbox-tick {
        opacity: 0;
    }

    @media (hover: hover) {
        .checkbox-container .checkbox:has(:checked):hover {
    ...
    .checkbox-container .checkbox:has(:checked):active {
        background-color: color-mix(
            in oklab,
            var(--pc-form-control-activated-color),
            var(--pc-color-mix-active)
...
<pc-tab-group sync-key="style-import">
