/**
 * This is similar to `textContent`, but better:
 *
 ...
 *
 * Set it to a positive integer to recurse that many levels. This is generally a tradeoff between performance and accuracy.
 */
export function getText(root: Node | Iterable<Node>, depth = 0): string {
