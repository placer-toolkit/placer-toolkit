...
export class PcDropdownItem extends PlacerElement {
    ...
    /** @internal The controller will set this property to `true` when at least one checkbox or radio exists in the dropdown. This allows non‐checkbox and non‐radio items to draw additional space to align properly with checkbox and radio items. */
    ...
    @property({ reflect: true }) type: "normal" | "checkbox" | "radio" =
        "normal";
