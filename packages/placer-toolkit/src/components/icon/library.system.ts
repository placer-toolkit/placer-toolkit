...
/* System icons are a separate library to ensure they’re always available,
   ...
   All Placer Toolkit components must use the system library instead of the default.
   For visual consistency, many system icons are a subset of Font Awesome Free. */
